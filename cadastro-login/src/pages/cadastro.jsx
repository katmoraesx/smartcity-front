    ...
    <div className="min-h-screen flex items-center justify-center bg-[#151539]">
      <div className="flex w-[700px] rounded-lg overflow-hidden">
        ...
        <div className="bg-[#dbe5f0] w-1/2 p-8 flex flex-col justify-center">
          <h2 className="text-xl font-bold text-center mb-1">Crie sua conta</h2>
          <p className="text-sm text-center mb-6">Preencha o formulário</p>
          <form className="flex flex-col gap-4">
            <input type="text" placeholder="Nome" className="px-4 py-2 rounded bg-[#ff6e6e] placeholder-white text-white" />
